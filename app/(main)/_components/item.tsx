...
const Item = ({
  ...
  return (
    <div
      ...
      className={cn("group min-h-[27px] text-sm py-1 pr-3 w-full",
    ...
    >
      {!!id && (
        <div
          role="button"
          className="h-full rounded-sm hover:bg-neutral-300l dark:hover:bg-neutral-600 mr-1 "
      ...
      {!!id && (
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            className="w-60 dark:bg-neutral-600"
            align="start"
            side="right"
            forceMount
            onClick={(e) => e.stopPropagation()}
